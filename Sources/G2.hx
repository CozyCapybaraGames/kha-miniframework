...
@:forward
abstract G2(kha.graphics2.Graphics) to kha.graphics2.Graphics from kha.graphics2.Graphics {
    public inline function new(g: kha.graphics2.Graphics) {
        this = g;
    }
	...
	public function drawInnerLine(x1: Float, y1: Float, x2: Float, y2: Float, strength: Float): Void {
		var side = y2 > y1 ? 1 : 0;
		if (y2 == y1)
			side = x2 - x1 > 0 ? 1 : 0;
	 ...
	 */
	public function drawPolygon(x: Float, y: Float, vertices: Array<Vector2>, strength: Float = 1) {
	 ...
	 */
	public function fillPolygon(x: Float, y: Float, vertices: Array<Vector2>) {
		var iterator = vertices.iterator();
	 ...
	 */
	public function drawCubicBezierPath(x: Array<Float>, y: Array<Float>, segments: Int = 20, strength: Float = 1.0): Void {
		var i = 0;
		var t: Float;
	...
	public function calculateCubicBezierPoint(t: Float, x: Array<Float>, y: Array<Float>): Array<Float> {
		var u: Float = 1 - t;
		var tt: Float = t * t;
		var uu: Float = u * u;
		var uuu: Float = uu * u;
	...
	public function drawAlignedCharacters(text: Array<Int>, start: Int, length: Int, x: Float, y: Float, horAlign: HorTextAlignment,
